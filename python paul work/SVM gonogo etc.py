...
np.save("SVM_outputs_temp/"+brain_area+"_"+type_of_analysis+"_experiments.npy",experiments)
np.save("SVM_outputs_temp/"+brain_area+"_"+type_of_analysis+"_accuracies.npy",accuracies)
np.save("SVM_outputs_temp/"+brain_area+"_"+type_of_analysis+"_ranks.npy",ranks)
np.save("SVM_outputs_temp/"+brain_area+"_"+type_of_analysis+"_dummy_distn.npy",dummy_distn)
np.save("SVM_outputs_temp/"+brain_area+"_"+type_of_analysis+"_Cs.npy",Cs)
np.save("SVM_outputs_temp/"+brain_area+"_"+type_of_analysis+"_mouse_ids.npy",mouse_ids)

...
all_neurons=np.load("processed_data/S1naive_all_neurons.npy",allow_pickle=True)
...
'''
step1=0.005
bins=np.arange(0.3,0.6+step1,step1)
...
plt.figure()
medians_hist=plt.hist(all_dummy_medians, label="dummy neuron sets",bins=bins)
